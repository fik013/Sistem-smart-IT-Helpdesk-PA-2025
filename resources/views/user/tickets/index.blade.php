                            ...
                            @forelse($tickets as $ticket)
                                <tr class="hover:bg-slate-50 dark:hover:bg-surface-dark/40 transition-colors group">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <button
                                            class="text-slate-400 dark:text-text-secondary hover:text-slate-900 dark:hover:text-white transition-colors p-1 rounded hover:bg-slate-100 dark:hover:bg-surface-border">
